...
return new class extends Migration
{
    ...
    {
        Schema::create('tic_company_draft_jobs', function (Blueprint $table) {
            $table->id('draft_job_id');
            ...
            $table->unsignedInteger('job_qualification_id')->nullable();
            $table->string('job_qualification', 255)->nullable();
            ...
            $table->string('job_posted_by_userid')->nullable();
    ...
    {
        Schema::dropIfExists('tic_company_draft_jobs');
    }
};
