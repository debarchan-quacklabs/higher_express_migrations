...
return new class extends Migration
{
    ...
    public function up()
{
    Schema::create('tic_tagged_recruiter_desire', function (Blueprint $table) {
        $table->id('tag_recruiter_desire_id'); // Primary key
    ...
    {
        Schema::dropIfExists('tic_tagged_recruiter_desires');
    }
};
