...
return new class extends Migration
{
    ...
    {
        Schema::create('tic_company_vendor_locations', function (Blueprint $table) {
            $table->id('vendor_location_id'); // Primary key

            $table->unsignedInteger('u_id')->nullable();
            $table->unsignedInteger('role_id')->nullable();
            $table->unsignedInteger('module_id')->nullable();

            $table->string('vendor_location_key', 255)->nullable();
    ...
    {
        Schema::dropIfExists('tic_company_vendor_locations');
    }
};
